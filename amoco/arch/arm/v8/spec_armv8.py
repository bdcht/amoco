...
def DecodeBitMasks(M,targs):
    ...
    if len<1 or M<(1<<len): raise InstructionError('bitmasks error')
    ...
    diff = S-R
    esize = 1<<len
    if M%esize != 0: raise InstructionError('bitmasks error')
    d = diff % esize
...
def sp2z(x):
    if x is env.sp: return env.xzr
    if x is env.wsp: return env.wzr
    return x
...
def A64_generic(obj,sf,S,shift,Rm,imm6,Rn,Rd):
    ...
    obj.setflags = (S==1)
    regs = env.Xregs if sf==1 else env.Wregs
    if shift==3: raise InstructionError(obj)
...
@ispec("32[ sf 00 100100 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="AND", setflags=False)
@ispec("32[ sf 01 100100 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="ORR", setflags=False)
@ispec("32[ sf 10 100100 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="EOR", setflags=False)
@ispec("32[ sf 11 100100 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="AND", setflags=True)
def A64_generic(obj,sf,N,immr,imms,Rn,Rd):
    obj.datasize = 64 if (sf==1) else 32
    regs = env.Xregs if sf==1 else env.Wregs
    if sf==0 and N!=0: raise InstructionError(obj)
...
@ispec("32[ sf 01 100110 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="BFM",  inzero=False, extend=False)
@ispec("32[ sf 00 100110 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="SBFM", inzero=True,  extend=True )
@ispec("32[ sf 10 100110 N immr(6) imms(6) Rn(5) Rd(5) ]", mnemonic="UBFM", inzero=True,  extend=False)
def A64_xBFM(obj,sf,N,immr,imms,Rn,Rd):
    obj.datasize = 64 if (sf==1) else 32
    regs = env.Xregs if sf==1 else env.Wregs
    if sf==1 and N!=1: raise InstructionError(obj)
    if sf==0 and (N!=0 or immr<32 or imms<32): raise InstructionError(obj)
    obj.d = sp2z(regs[Rd])
    obj.n = sp2z(regs[Rn])
    obj.immr = cst(immr,6)
    obj.imms = cst(imms,6)
...
@ispec("32[ sf 00 01010 shift(2) 0 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="AND", setflags=False, invert=False)
@ispec("32[ sf 01 01010 shift(2) 0 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="ORR", setflags=False, invert=False)
@ispec("32[ sf 10 01010 shift(2) 0 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="EOR", setflags=False, invert=False)
@ispec("32[ sf 11 01010 shift(2) 0 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="AND", setflags=True , invert=False)
@ispec("32[ sf 00 01010 shift(2) 1 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="BIC", setflags=False, invert=True)
@ispec("32[ sf 01 01010 shift(2) 1 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="ORN", setflags=False, invert=True)
@ispec("32[ sf 10 01010 shift(2) 1 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="EON", setflags=False, invert=True)
@ispec("32[ sf 11 01010 shift(2) 1 Rm(5) imm6(6) Rn(5) Rd(5) ]", mnemonic="BIC", setflags=True,  invert=True)
...
@ispec("32[ 1-=size(2) 001000 1=o2 1 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDAR")
@ispec("32[ 1-=size(2) 001000 0=o2 1 0=o1 11111=Rs(5) 0=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDXR")
@ispec("32[ 1-=size(2) 001000 0=o2 1 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDAXR")
@ispec("32[ 1-=size(2) 001000 1=o2 0 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLR")
@ispec("32[ 1-=size(2) 001000 1=o2 0 1=o1       Rs(5) 1=o0       Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLXP")
@ispec("32[ 1-=size(2) 001000 0=o2 0 1=o1       Rs(5) 0=o0       Rt2(5) Rn(5) Rt(5) ]",mnemonic="STXP")
@ispec("32[ 1-=size(2) 001000 0=o2 0 0=o1       Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLXR")
@ispec("32[ 1-=size(2) 001000 0=o2 0 0=o1       Rs(5) 0=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STXR")
@ispec("32[ 00=size(2) 001000 0=o2 0 0=o1       Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLXRB")
@ispec("32[ 01=size(2) 001000 0=o2 0 0=o1       Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLXRH")
@ispec("32[ 00=size(2) 001000 0=o2 0 0=o1       Rs(5) 0=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STXRB")
@ispec("32[ 01=size(2) 001000 0=o2 0 0=o1       Rs(5) 0=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STXRH")
@ispec("32[ 00=size(2) 001000 1=o2 1 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDARB")
@ispec("32[ 00=size(2) 001000 1=o2 0 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLRB")
@ispec("32[ 01=size(2) 001000 1=o2 1 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDARH")
@ispec("32[ 01=size(2) 001000 1=o2 0 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="STLRH")
@ispec("32[ 00=size(2) 001000 0=o2 1 0=o1 11111=Rs(5) 0=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDXRB")
@ispec("32[ 00=size(2) 001000 0=o2 1 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDAXRB")
@ispec("32[ 01=size(2) 001000 0=o2 1 0=o1 11111=Rs(5) 0=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDXRH")
@ispec("32[ 01=size(2) 001000 0=o2 1 0=o1 11111=Rs(5) 1=o0 11111=Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDAXRH")
@ispec("32[ 1-=size(2) 001000 0=o2 1 1=o1 11111=Rs(5) 1=o0       Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDAXP")
@ispec("32[ 1-=size(2) 001000 0=o2 1 1=o1 11111=Rs(5) 0=o0       Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDXP")
...
@ispec("32[ -0=opc(2) 101 0 000 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDNP",  wback=False, postindex=False)
@ispec("32[ -0=opc(2) 101 0 001 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDP",   wback=True,  postindex=True)
@ispec("32[ -0=opc(2) 101 0 011 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDP",   wback=True,  postindex=False)
@ispec("32[ -0=opc(2) 101 0 010 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDP",   wback=False, postindex=False)
@ispec("32[ -0=opc(2) 101 0 000 0 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="STNP",  wback=False, postindex=False)
@ispec("32[ -0=opc(2) 101 0 001 0 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="STP",   wback=True,  postindex=True)
@ispec("32[ -0=opc(2) 101 0 011 0 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="STP",   wback=True,  postindex=False)
@ispec("32[ -0=opc(2) 101 0 010 0 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="STP",   wback=False, postindex=False)
@ispec("32[ 01=opc(2) 101 0 001 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDPSW", wback=True,  postindex=True)
@ispec("32[ 01=opc(2) 101 0 011 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDPSW", wback=True,  postindex=False)
@ispec("32[ 01=opc(2) 101 0 010 1 imm7(7) Rt2(5) Rn(5) Rt(5) ]",mnemonic="LDPSW", wback=False, postindex=False)
...
@ispec("32[ 1-=size(2) 111 0 00 01=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="LDR", wback=True, postindex=True)
@ispec("32[ 1-=size(2) 111 0 00 01=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="LDR", wback=True, postindex=False)
@ispec("32[ 1-=size(2) 111 0 00 01=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="LDTR", wback=False, postindex=False)
@ispec("32[ 1-=size(2) 111 0 00 00=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="STTR", wback=False, postindex=False)
@ispec("32[ 1-=size(2) 111 0 00 01=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="LDUR", wback=False, postindex=False)
@ispec("32[ 1-=size(2) 111 0 00 00=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="STUR", wback=False, postindex=False)
@ispec("32[ 1-=size(2) 111 0 00 00=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="STR", wback=True, postindex=True)
@ispec("32[ 1-=size(2) 111 0 00 00=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="STR", wback=True, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 01=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="LDRB", wback=True, postindex=True)
@ispec("32[ 00=size(2) 111 0 00 01=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="LDRB", wback=True, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 00=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="STRB", wback=True, postindex=True)
@ispec("32[ 00=size(2) 111 0 00 00=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="STRB", wback=True, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 01=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="LDTRB", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 00=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="STTRB", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 01=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="LDURB", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 00=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="STURB", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 01=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="LDRH", wback=True, postindex=True)
@ispec("32[ 01=size(2) 111 0 00 01=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="LDRH", wback=True, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 00=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="STRH", wback=True, postindex=True)
@ispec("32[ 01=size(2) 111 0 00 00=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="STRH", wback=True, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 01=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="LDTRH", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 00=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="STTRH", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 01=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="LDURH", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 00=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="STURH", wback=False, postindex=False)
@ispec("32[ 10=size(2) 111 0 00 10=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="LDRSW", wback=True, postindex=True)
@ispec("32[ 10=size(2) 111 0 00 10=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="LDRSW", wback=True, postindex=False)
@ispec("32[ 10=size(2) 111 0 00 10=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="LDTRSW", wback=False, postindex=False)
@ispec("32[ 10=size(2) 111 0 00 10=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="LDURSW", wback=False, postindex=False)
@ispec("32[ 11=size(2) 111 0 00 10=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="PRFUM", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="LDRSB", wback=True, postindex=True)
@ispec("32[ 00=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="LDRSB", wback=True, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="LDTRSB", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="LDURSB", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 01 Rn(5) Rt(5) ]",mnemonic="LDRSH", wback=True, postindex=True)
@ispec("32[ 01=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 11 Rn(5) Rt(5) ]",mnemonic="LDRSH", wback=True, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 10 Rn(5) Rt(5) ]",mnemonic="LDTRSH", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 00 1-=opc(2) 0 imm9(9) 00 Rn(5) Rt(5) ]",mnemonic="LDURSH", wback=False, postindex=False)
...
@ispec("32[ 1-=size(2) 111 0 01 01=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="LDR", wback=False, postindex=False)
@ispec("32[ 1-=size(2) 111 0 01 00=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="STR", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 01 01=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="LDRB", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 01 00=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="STRB", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 01 01=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="LDRH", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 01 00=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="STRH", wback=False, postindex=False)
@ispec("32[ 10=size(2) 111 0 01 10=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="LDRSW", wback=False, postindex=False)
@ispec("32[ 11=size(2) 111 0 01 10=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="PRFM", wback=False, postindex=False)
@ispec("32[ 00=size(2) 111 0 01 1-=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="LDRSB", wback=False, postindex=False)
@ispec("32[ 01=size(2) 111 0 01 1-=opc(2) imm12(12) Rn(5) Rt(5) ]",mnemonic="LDRSH", wback=False, postindex=False)
...
@ispec("32[ 1-=size(2) 111 0 00 01=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="LDR")
@ispec("32[ 1-=size(2) 111 0 00 00=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="STR")
@ispec("32[ 00=size(2) 111 0 00 01=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="LDRB")
@ispec("32[ 00=size(2) 111 0 00 00=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="STRB")
@ispec("32[ 01=size(2) 111 0 00 01=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="LDRH")
@ispec("32[ 01=size(2) 111 0 00 00=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="STRH")
@ispec("32[ 00=size(2) 111 0 00 1-=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="LDRSB")
@ispec("32[ 01=size(2) 111 0 00 1-=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="LDRSH")
@ispec("32[ 10=size(2) 111 0 00 10=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="LDRSW")
@ispec("32[ 11=size(2) 111 0 00 10=opc(2) 1 Rm(5) option(3) S 10 Rn(5) Rt(5) ]",mnemonic="PRFM")
def A64_load_store(obj,size,opc,Rm,option,S,Rn,Rt):
    obj.wback = False
    obj.postindex = False
    obj.scale = size
    obj.datasize = 8<<obj.scale
    if option&2==0: raise InstructionError(obj)
    obj.extend_type = option
