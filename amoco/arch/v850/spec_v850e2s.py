...
def _chk_reg_null(obj,r):
    if r==0: raise InstructionError(obj)
...
def v850_reg_reg(obj,reg1,reg2,_chk=0):
    if _chk&1: _chk_reg_null(obj,reg1)
    if _chk&2: _chk_reg_null(obj,reg2)
...
def v850_fetrap(obj,v):
    if v==0: raise InstructionError(obj)
    vector = env.cst(v,4)
    obj.operands = [vector]
    obj.type = type_system
...
@ispec("64<[ imm32(32) ~lh(11) ff(2) 011 00000 11110 imm(5) ~lo(1) ]", mnemonic='PREPARE')
...
#format XIV
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 0101 00000 111100 reg1(5) ]", mnemonic='LDB' ,_size=8)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 0101 00000 111101 reg1(5) ]", mnemonic='LDBU',_size=8)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 0111 00000 111100 reg1(5) ]", mnemonic='LDH' ,_size=16)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 0111 00000 111101 reg1(5) ]", mnemonic='LDHU',_size=16)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 1001 00000 111100 reg1(5) ]", mnemonic='LDW' ,_size=32)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 1101 00000 111100 reg1(5) ]", mnemonic='STB' ,_size=8)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 1101 00000 111101 reg1(5) ]", mnemonic='STH' ,_size=16)
@ispec("48<[ ~dhi(16) reg3(5) ~dlo(7) 1111 00000 111100 reg1(5) ]", mnemonic='STW' ,_size=32)
